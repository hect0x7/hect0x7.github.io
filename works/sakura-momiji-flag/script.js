...
const zh = {
    ...
    daigojiTitle: '塔立于花间，<br>白色有了向上的高度。', daigojiBody: '醍醐寺的樱花点缀着朱红的弁天堂，把春天向上托起。旗面的白不只是横向的辽阔，更多了秩序与升腾。',
    ...
    ledgerTitle: '白与红，<br>共同完成一面旗。', ledgerLead: '地点不是清单，而是颜色的证据。', ledgerVerse: '<p class="verse-white"><span class="verse-mark">花</span>樱花在水、路、山、海、舟与塔之间，<em>铺开白</em>。</p><p class="verse-red"><span class="verse-mark">葉</span>红叶借雪峰、舞台、池水、山径、塔影与潮水，<em>向中心聚拢</em>。</p>', ledgerWhite: '樱花之白', ledgerRed: '红叶之红',
...
const ja = {
    ...
    daigojiTitle: '塔が花のなかに立ち、<br>白に上へのびる高さが生まれる。', daigojiBody: '醍醐寺の桜が朱塗りの弁天堂を彩り、春を上へと持ち上げる。旗の白は横の広がりだけでなく、秩序と上昇を得る。',
    ...
    ledgerTitle: '白と赤。<br>一つの旗へ。', ledgerLead: '地名は一覧ではなく、色の証しである。', ledgerVerse: '<p class="verse-white"><span class="verse-mark">花</span>桜は水・道・山・海・舟・塔のあいだに、<em>白を広げ</em>。</p><p class="verse-red"><span class="verse-mark">葉</span>紅葉は雪峰・舞台・池・山道・塔影・潮を借りて、<em>中心へ集う</em>。</p>', ledgerWhite: '桜の白', ledgerRed: '紅葉の赤',
...
const en = {
    ...
    daigojiTitle: 'The pagoda stands among blossoms.<br>White gains upward height.', daigojiBody: 'At Daigo-ji, sakura frames the vermilion Bentendo hall and lifts spring upward. The flag\'s white gains not only breadth, but order and ascent.',
