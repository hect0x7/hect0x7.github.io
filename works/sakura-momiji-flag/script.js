...
const zh = {
    ...
    introTitle: '循着花与叶，<br>走进两种季节。', introBody: '樱花穿过水岸与山野，红叶漫过庭园与海边。十二处风景，让春与秋共同走向一面旗。',
...
const ja = {
    ...
    introTitle: '花と葉をたどり、<br>二つの季節へ。', introBody: '桜は水辺と山野をめぐり、紅葉は庭と海辺を彩る。十二の風景から、春と秋が一つの旗へ向かう。',
...
const en = {
    ...
    introTitle: 'Follow blossom and leaf.<br>Enter two seasons.', introBody: 'Sakura crosses watersides and mountain landscapes; maple leaves color gardens and shores. Across twelve scenes, spring and autumn move toward one flag.',
